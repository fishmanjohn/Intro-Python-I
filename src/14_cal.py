...
x = input('Enter a month to get a calender: ')
y = input('Enter a year to get a calender: ')
...
def get_month(themonth=0, theyear=0):
  if theyear == None and themonth == None:
    ...
    x = datetime.now()
    print(calendar.month(x.year, int(themonth)))
  else:
    print(calendar.month(int(theyear), int(themonth)))
